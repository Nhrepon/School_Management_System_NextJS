      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-white text-lg font-semibold">NSMS</h3>
            <p className="text-sm">
              Providing innovative solutions for your business needs. We are committed to excellence and customer satisfaction.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm">
              © {currentYear} NSMS. All rights reserved.
            </p>
